...
// p2 solved in brute force, runs for ~3s in my case; first iterate by jumps of 100 and figure out where most likely the lowest loc is, then run that range by 1.. worked ¯\_(ツ)_/¯
