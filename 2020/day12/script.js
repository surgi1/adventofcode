...
function advanceShip(step) {
    ...
    switch (action) {
        ...
        case 'F': 
            //ship.x = ship.x + value*(Math.round(Math.cos(ship.r*(Math.PI/180))));
            //ship.y = ship.y - value*(Math.round(Math.sin(ship.r*(Math.PI/180))));
...
// p2 guess: 59364 too low, 101860 correct